...
whpg cgroup 서비스 등록
sudo tee -a /etc/systemd/system/gpdb.servive << EOF
```
[Unit]
...
# cgroup v2 활성화 확인: 재부팅 후 아래 명령어로 cgroup2fs가 출력되는지 확인합니다
